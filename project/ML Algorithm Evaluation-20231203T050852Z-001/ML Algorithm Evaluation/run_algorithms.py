...
def main():
	...
	dataset = "D://phishing site detection//Chrome-Extension-for-Phishing-website-detection-master//Chrome-Extension-for-Phishing-website-detection-master//backend//Dataset.csv"
	class_labels = "D://phishing site detection//Chrome-Extension-for-Phishing-website-detection-master//Chrome-Extension-for-Phishing-website-detection-master//backend//Target_Labels.csv"
	test_size = 0.3

	print ("/nrunning neural networks...")
	...
	print ("/nrunning support vector machines...")
	start_time = time.time()
